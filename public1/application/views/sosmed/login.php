...
include_once base_url()."/assets/sosmed/config.php";
include_once base_url()."/assets/sosmed/inc/twitteroauth.php";
?>
<html>
<head>
...
{	//Success, redirected back from process.php with varified status.
	...
	//login button
	echo '<a href="'base_url().'assets/sosmed/processtwitter.php"><img src="images/sign-in-with-twitter-l.png" width="151" height="24" border="0" /></a>';
...
$redirect_url = 'http://lg.kanadigital.com/public/menupertama/login';
...
$logout = 'http://lg.kanadigital.com/public/menupertama/?logout=true';
