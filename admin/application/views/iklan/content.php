<div class="content outlet">
            ...
            <div class="col1">		 
               <h2 class="fr"><a href="<?= base_url() ?>iklan/addcontent" class="button2">Add New</a></h2>         
			...
			?>
				<tr>
					...
					<td><?= $cont['iklan']?></td>
					<td><?= $cont['harga']?></td>
					<td><?= $cont['hrg_diskon']?></td>
					<td><?= $cont['produk']?></td>
					<td><?= $cont['logo_toko']?></td>		
					<td> <?php if($cont['stat']==1){
						echo "Active";
					}else if($cont['stat']==0){
						echo "Inactive";
					}else{
					...
					<td><a href="<?= base_url()."iklan/contentedit/".$cont['ids'];?>" class="button2">Edit</a>
				   
					<?php
						if(($cont['stat']==0)){
							echo "<a href='".base_url()."iklan/Actived/".$cont['ids']."' class='button2'>Approved</a>";
							echo "<a href='".base_url()."iklan/Delete/".$cont['ids']."' class='button2'>Delete</a>";
						}else if($cont['stat']==1){
							echo "<a href='".base_url()."iklan/Inactive/".$cont['ids']."' class='button2'>Inactive</a>";
						}					
					?>
					</td>
				</tr>
