            ...
            <div  class="col-md-12">
                <div class="w100">
                    <div class="heading center">
                        <div class="entry">
                            <h1 class="red">Once Upon A Time, Me and LG...</h1>
                    ...
                    <div class="content">
                        <!--<form id="formcerita" class="theForm" method="post"enctype="multipart/form-data" action="Page/insertcerita"> -->
						<form id="formcerita" class="theForm" method="post"enctype="multipart/form-data" action="#">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="No. Tlpn*" name="notelp" id="notelp"/>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="customselect">
                                        <select name="jns_produk" id="produk"/>
                                ...
                                <div class="col-md-12">
                                    <textarea onkeyup="writeText();" id="ceritatext" placeholder="Kesan pertama Anda tentang LG" class="message" name="cerita" maxlength="140"/></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span>Saya menyetujui <a href="index.php?page=term">Syarat &amp; Ketentuan</a></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="itemContainer">
                        ...
                        <div class="meta">
                                ...
                                <div class="userdetail">
                                    <span class="username">Dian Aprilia</span>
                                    <span class="userID">@dianaprilia</span>
                                </div>
                        </div>
                        <div class="sharebox">
...
<div class="popup">
    <div id="popup-message" class="popup-container">
        <div class="popup-entry">
            ...
            <a href="<?php echo $url; ?>" class="button btnred btnClosePopup"> Sign in to Facebook</a>
			<a href="<?= base_url()?>pagenew/twitter" class="button btnred btnClosePopup"> Sign in to Twitter</a>
...
<script type="text/javascript">
    ...
    function updateCountdown() {
        ...
        jQuery('.countdown').text(remaining + ' Karakter lagi.');
    }
     updateCountdown();
    ...
    function save_via_ajax(){    
        ...
        $.ajax({
                ...
                data: "nama="+nama+"&notelp="+notelp+"&email="+email+"&kesan="+cropvalue+"&produk="+produk,
                beforeSend: function(){
                $("#loading-box").show();
            },
