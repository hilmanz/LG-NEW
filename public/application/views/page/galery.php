										...
										<div class="sharebox">
											...
											if ($row4->cerita){
												echo "<a rel='nofollow' class='sharebtn' href='http://twitter.com/intent/tweet?text=LG, Lifes Good 123 ".base_url()."page/".$row4->cerita."' title='Tweet About It!' target='_blank'><i class='icon-twitter'>&nbsp;</i></a>";
													?>
											   <a class="sharebtn" href='javascript:void(0)' onclick="shareFB('Cerita','http://lg.kanadigital.com/public/page/uploadcerita','http://lg.kanadigital.com/public/page/<?php echo $row4->cerita; ?>','','Seen the new campaign LG Take a peek on LG Website to find out more.')"><i class="icon-facebook">&nbsp;</i></a>
											   <?
												}
												if ($row4->image){
													...
													?>
											   <a class="sharebtn" href='javascript:void(0)' onclick="shareFB('photo','http://lg.kanadigital.com/public/page/uploadcerita','http://lg.kanadigital.com/public/page/<?php echo $row4->image; ?>','','Seen the new campaign LG Take a peek on LG Website to find out more.')"><i class="icon-facebook">&nbsp;</i></a>
											   <?
												}
											   ?>
											</div>
