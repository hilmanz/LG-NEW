...
<title><?php $title; ?></title>
	...
	<script type="text/javascript" src="<?= base_url()?>assets/js/jquery.mousewheel-3.0.4.pack.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/css/jquery.fancybox-1.3.4.css" media="screen" />
 	<link rel="stylesheet" href="<?= base_url()?>assets/css/stylefancybox.css" />
