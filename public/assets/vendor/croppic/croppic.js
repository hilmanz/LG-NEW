...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createCropControls: function(){
			...
			html =  '<div class="cropControls cropControlsCrop">'+ cropControlZoomMuchIn + cropControlZoomMuchOut + cropControlRotateRight + cropControlRotateLeft + cropControlReset + '</div>';
